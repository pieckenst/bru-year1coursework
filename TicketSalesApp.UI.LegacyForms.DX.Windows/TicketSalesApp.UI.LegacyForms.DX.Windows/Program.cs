...
namespace TicketSalesApp.UI.LegacyForms.DX.Windows
{
    internal static class Program
    {
        ...
        private static void HandleFatalException(Exception ex)
        {
            ...
            Log.Fatal("AppDomain Configuration File: " + AppDomain.CurrentDomain.SetupInformation.ConfigurationFile);
            ...
            try
            {
                ...
                reportBuilder.AppendLine("AppDomain Configuration File: " + AppDomain.CurrentDomain.SetupInformation.ConfigurationFile);
